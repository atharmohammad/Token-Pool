...
pub fn process_instruction(
    ...
    match instruction.variant {
        ...
        1 => {
            ...
            // check if the amount depositing is greater than amount left to reach target , if this is the case only deposited amount needed to reach the target amount
            ...
            let transfer_inst = transfer(member_info.key, vault_info.key, depositable_amount);
            invoke(&transfer_inst, &[member_info.clone(), vault_info.clone()])?;
